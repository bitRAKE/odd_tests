...
start:
	...
	; Note: floats in x64 are passed in XMM registers. 
	; The invoke macro handles 'float 32.0' conversion if recognized, 
	; but to be safe with all assembler versions, we can pass the bits directly 
	; or rely on the macro. win64a's invoke usually handles "32.0" correctly.
